...
function AccelarationReadings() {
    ...
    return (
        ...
        <div className="flex flex-col items-center text-center p-2 md:p-20 bg-green-400" id="companies_list">
            <div className="md:text-3xl text-2xl font-bold pb-3 pt-3 flex flex-row">
