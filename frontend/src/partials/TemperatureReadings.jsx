...
function TemperatureReadings() {
  ...
  return (
      ...
      <div className="flex flex-col items-center text-center bg-blue-100 p-2 md:py-20" id="companies_list">
        ...
        <iframe style={iframeStyle} src="https://thingspeak.com/channels/2165919/charts/5?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line&update=15"></iframe>
